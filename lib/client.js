...
function Client(config) {
  ...
  this.handleJoinMatch = function (params) {
    ...
    console.log(
      "Joined match with ID " + params.match.id + " and rule " + params.ruleName
    );
  ...
  this.reqPlayRandom = function (ruleName, params, callback) {
    ...
    this.sendMessage(comm.Message.PLAY_RANDOM, params, callback);
  };
